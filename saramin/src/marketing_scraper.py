...
DB_PATH = os.path.join(os.path.dirname(__file__), '..', 'data', 'marketing_project', 'marketing_jobs.db')
...
def scrape_listings(conn):
    ...
    for page in range(1, 26):
        print(f"Scraping list page {page}/25 (up to 1000 items)...")
...
def main():
    ...
    csv_path = os.path.join(os.path.dirname(DB_PATH), 'marketing_jobs.csv')
